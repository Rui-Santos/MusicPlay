<?php
/*
Template Name: Gallery 3 Column
*/
...
get_header(); ?>
	...
	<div class="inner">
		...
		<div class="content-area">
			...
			$orderby = get_option('atp_album_orderby') ? get_option('atp_gallery_orderby') : 'date';
			$order   = get_option('atp_album_order') ? get_option('atp_gallery_order') : 'ASC';	
			...
			if ( $wp_query->have_posts()) : while (  $wp_query->have_posts()) :  $wp_query->the_post(); 
				...
				<div class="gallery-list <?php echo $class. ' ' .$last; ?>">
